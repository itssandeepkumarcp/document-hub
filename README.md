...
Current problem - client has a lot of documents (mostly scanned pdfs or images of documents) which are grouped by projects. Each project can have many documents. Currently they are stored on personal PCs, some on google drive.
